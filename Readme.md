...
Pestast generates a static typed abstract syntax tree (AST) for your pest grammar. The generation is done with a separate `Ast` derive macro, which makes it very modular.
...
* **example** Contains some examples and benchmarks.
